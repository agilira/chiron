...
const CRITICAL_ASSETS = [
  ...
  '/it/test-jit-nesting.html',
  '/it/test-mdx-real.html',
  ...
  '/test-react.html',
  '/test-section.html',
  '/test-server-island.html',
  '/test-serverisland-simple.html',
  ...
  '/test-vue.html',
  '/toc-depth-test.html',
  '/assets/SvelteCard.uMo_iPKd.css',
  '/assets/SvelteCounter.d2M8wGJg.css',
  '/assets/VueButton.Q_gxgezR.css',
  '/assets/VueCounter.-YW_xCwG.css',
  '/assets/VueCounter.-b8Sc-nG.css',
  '/assets/VueCounter.15h4ZwFQ.css',
  '/fonts.css',
  '/styles.css'
...
const STATIC_ASSETS = [
  ...
  '/favicon-512.png',
  '/og-image.png',
  '/assets/Button.react.v90eJSHL.bootstrap.js',
  '/assets/Button.react.v90eJSHL.js',
  '/assets/Card.react.UppLsGFu.bootstrap.js',
  '/assets/Card.react.UppLsGFu.js',
  '/assets/Counter.64eR0oSD.js',
  '/assets/Counter.react.3DkyCotL.bootstrap.js',
  '/assets/Counter.react.3DkyCotL.js',
  '/assets/Counter.react.NDCuliTY.js',
  '/assets/Counter.react.q2kvTQFS.js',
  '/assets/Counter.solid.lALYap8l.bootstrap.js',
  '/assets/Counter.solid.lALYap8l.js',
  '/assets/PreactChart.kIEbX_0v.bootstrap.js',
  '/assets/PreactChart.kIEbX_0v.js',
  '/assets/PreactCounter.8F0jhy7H.js',
  '/assets/PreactCounter.Amx68HXH.js',
  '/assets/PreactCounter.pkdprr2d.bootstrap.js',
  '/assets/PreactCounter.pkdprr2d.js',
  '/assets/SvelteCard.uMo_iPKd.bootstrap.js',
  '/assets/SvelteCard.uMo_iPKd.js',
  '/assets/SvelteCounter.d2M8wGJg.bootstrap.js',
  '/assets/SvelteCounter.d2M8wGJg.js',
  '/assets/VueButton.Q_gxgezR.bootstrap.js',
  '/assets/VueButton.Q_gxgezR.js',
  '/assets/VueCounter.-YW_xCwG.js',
  '/assets/VueCounter.-b8Sc-nG.js',
  '/assets/VueCounter.15h4ZwFQ.bootstrap.js',
  '/assets/VueCounter.15h4ZwFQ.js',
  '/assets/Wrapper-123.yYPDlJG3.js',
  '/assets/Wrapper-dedup.MEo81s85.js',
  '/assets/Wrapper_9OJcyMgr.WYYGAD0f.bootstrap.js',
  '/assets/Wrapper_9OJcyMgr.WYYGAD0f.js',
  '/assets/Wrapper_dnuU_ur8.mJCCubQT.bootstrap.js',
  '/assets/Wrapper_dnuU_ur8.mJCCubQT.js',
  '/assets/Wrapper_wX7pD6aY.q_iX_CTZ.bootstrap.js',
  '/assets/Wrapper_wX7pD6aY.q_iX_CTZ.js',
  '/assets/react-api-explorer.js',
  '/assets/react-runtime.5910f584.js',
  '/assets/react-runtime.82462ec1.js',
  '/assets/react-runtime.d3f5eba6.js',
  '/assets/react-runtime.js',
  '/assets/test-data-island.js',
  '/assets/vue-runtime.3e4d5d84.js',
  '/assets/vue-runtime.4b1d4139.js',
  '/assets/vue-runtime.a51056a3.js',
  '/assets/vue-runtime.ef970a4a.js',
